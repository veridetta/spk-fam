...
<div class="col-12 p-4 mt-4">
    <h2>Data Kriteria</h2>
    <div class="mb-3">
        <a type="button" class="btn btn-info" href="?page=admin_kriteria_tambah">
            Tambah Kriteria
        </a>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#kriteriaTable').DataTable({
            ajax: {
                url: 'ajax/get_kriteria.php', // Ganti dengan URL sesuai kebutuhan
                dataSrc: ''
            },
            columns: [
                { data: null },
    ...
    function editKriteria(id) {
        ...
        window.location.href = '?page=admin_kriteria_edit&id=' + id;
    }
    ...
    function hapusKriteria(id) {
        ...
        if (confirm('Apakah Anda yakin ingin menghapus kriteria ini?')) {
            ...
            window.location.href = 'action/kriteria_hapus.php?id=' + id;
        }
    }
</script>

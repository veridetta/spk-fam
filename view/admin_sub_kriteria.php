...
<div class="col-12 p-4 mt-4">
    ...
    <div class="mb-3">
        <a type="button" class="btn btn-info" href="?page=admin_sub_kriteria_tambah">
            Tambah Sub Kriteria
        </a>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#kriteriaTable').DataTable({
            ajax: {
                url: 'ajax/get_sub_kriteria.php', // Ganti dengan URL sesuai kebutuhan
                dataSrc: ''
            },
            columns: [
                { data: null },
    ...
    function editKriteria(id) {
        ...
        window.location.href = '?page=admin_sub_kriteria_edit&id=' + id;
    }
    ...
    function hapusKriteria(id) {
        ...
        if (confirm('Apakah Anda yakin ingin menghapus kriteria ini?')) {
            ...
            window.location.href = 'action/sub_kriteria_hapus.php?id=' + id;
        }
    }
</script>
